...
# CC Compiler Flags
CCFLAGS=-lpthread -lreadline -l wiringPi
CXXFLAGS=-lpthread -lreadline -l wiringPi
...
${OBJECTDIR}/src/GBlock.o: src/GBlock.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GBlock.o src/GBlock.cpp

${OBJECTDIR}/src/GReader.o: src/GReader.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GReader.o src/GReader.cpp

${OBJECTDIR}/src/GThread.o: src/GThread.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GThread.o src/GThread.cpp

${OBJECTDIR}/src/Gunit.o: src/Gunit.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Gunit.o src/Gunit.cpp

${OBJECTDIR}/src/MGaxis.o: src/MGaxis.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MGaxis.o src/MGaxis.cpp

${OBJECTDIR}/src/MGmath.o: src/MGmath.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MGmath.o src/MGmath.cpp

${OBJECTDIR}/src/MGstepper.o: src/MGstepper.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MGstepper.o src/MGstepper.cpp
...
${TESTDIR}/tests/angluefunctest.o: tests/angluefunctest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/angluefunctest.o tests/angluefunctest.cpp
...
${OBJECTDIR}/src/GBlock_nomain.o: ${OBJECTDIR}/src/GBlock.o src/GBlock.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GBlock_nomain.o src/GBlock.cpp;\
	else  \
...
${OBJECTDIR}/src/GReader_nomain.o: ${OBJECTDIR}/src/GReader.o src/GReader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GReader_nomain.o src/GReader.cpp;\
	else  \
...
${OBJECTDIR}/src/GThread_nomain.o: ${OBJECTDIR}/src/GThread.o src/GThread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GThread_nomain.o src/GThread.cpp;\
	else  \
...
${OBJECTDIR}/src/Gunit_nomain.o: ${OBJECTDIR}/src/Gunit.o src/Gunit.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Gunit_nomain.o src/Gunit.cpp;\
	else  \
...
${OBJECTDIR}/src/MGaxis_nomain.o: ${OBJECTDIR}/src/MGaxis.o src/MGaxis.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MGaxis_nomain.o src/MGaxis.cpp;\
	else  \
...
${OBJECTDIR}/src/MGmath_nomain.o: ${OBJECTDIR}/src/MGmath.o src/MGmath.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MGmath_nomain.o src/MGmath.cpp;\
	else  \
...
${OBJECTDIR}/src/MGstepper_nomain.o: ${OBJECTDIR}/src/MGstepper.o src/MGstepper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MGstepper_nomain.o src/MGstepper.cpp;\
	else  \
...
${OBJECTDIR}/src/config_nomain.o: ${OBJECTDIR}/src/config.o src/config.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config_nomain.o src/config.cpp;\
	else  \
