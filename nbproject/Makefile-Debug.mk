...
${OBJECTDIR}/src/MotorCtl.o: src/MotorCtl.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MotorCtl.o src/MotorCtl.cpp
...
${OBJECTDIR}/src/MotorCtl_nomain.o: ${OBJECTDIR}/src/MotorCtl.o src/MotorCtl.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MotorCtl_nomain.o src/MotorCtl.cpp;\
	else  \
